<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ClassFees.aspx.cs" Inherits="WebApplication1.Admin.ClassFees" %>
        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btdAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#5558C9" Text="Add Class" OnClick="btdAdd_Click" />
                </div>
            </div>
              <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-8">
